...
\noindent
These tasks share the same underlying processing chain. Image acquisition and
preprocessing produce reliable low-level measurements, mid-level analysis groups
them into features and segments, and the high-level stage turns those into the
task-specific output above. The choice of task fixes the form of the answer, but
the bottom-up evidence and top-down knowledge feeding into it are the same.
